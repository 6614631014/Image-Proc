...
import numpy as np
from glob import glob  #อ่านไฟล์ทั้งหมดในโฟเดอร์ที่เลือก
...
if __name__ == "__main__":
    ...
    for f in input_files:
        ...
        # feature
        _, eccen = regionBasedFeatures(morph_img, "eccentricity")   #eccentricity รี  
        print(eccen[0])
        ...
        plt.imshow(rgb_img)
        plt.subplot(1, 2, 2)
        plt.title(f"Leaf_Class:{leaf_class}")
